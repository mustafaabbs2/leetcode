...
//same as last time, but we can't use the previous algorithm - we will get duplicate subsets
// Example for {1,3,1}
// 1
// 3
// 1 3
...
//Solution - sort the list, and add the duplicate element only to the most latest created sets
